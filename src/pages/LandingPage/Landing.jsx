...
export default function Landing(){
    ...
    {
        allData.arrCategories.map((item)=>{
    ...
    <img src="https://m.media-amazon.com/images/G/31/img22/Fashion/AF/Newseason/revamp/N2GLoffers/cashback-pc._CB590089559_.gif" width="100%" height="300px" style={{marginTop:"30px"}}></img>
</div>)
}